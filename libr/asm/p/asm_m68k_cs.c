...
#define M68K_LONGEST_INSTRUCTION 11 //MOVE.L ([bd,An,Xn]od),([bd,An,Xn]od); this instruction can be up to 11 words, you can get more data on the bus but not instruction size.
